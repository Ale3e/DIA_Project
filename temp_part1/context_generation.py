...
p = np.array([[0.283, 0.193, 0.129, 0.061, 0.012],[0.298, 0.210, 0.135, 0.063, 0.014],[0.251, 0.151, 0.118, 0.054, 0.009]])
...
for e in range(0,n_experiments):
    ...
    ts_learner = UCB1_Learner(n_arms=n_arms)
    gr_learner = UCB1_Learner(n_arms=n_arms)
